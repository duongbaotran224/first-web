...
import { Card, CardContent, Avatar, SvgIcon, IconButton } from '@material-ui/core';
            ...
            {data.map((item, index) => {
                return (
                    <Grid item sm={6} xs={12}>
                        <Card key={index} className={classes.grid_item}>
